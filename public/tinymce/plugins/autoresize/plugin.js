...
var autoresize = (function () {
  ...
  var resize = function (editor, oldSize) {
    ...
    body = doc.body;
    resizeHeight = $_b6olzc82jcgfo3fz.getAutoResizeMinHeight(editor);
    ...
    if (myHeight > $_b6olzc82jcgfo3fz.getAutoResizeMinHeight(editor)) {
      resizeHeight = myHeight;
    }
    var maxHeight = $_b6olzc82jcgfo3fz.getAutoResizeMaxHeight(editor);
  ...
  var setup = function (editor, oldSize) {
    editor.on('init', function () {
      ...
      var dom = editor.dom;
      overflowPadding = $_b6olzc82jcgfo3fz.getAutoResizeOverflowPadding(editor);
      bottomMargin = $_b6olzc82jcgfo3fz.getAutoResizeBottomMargin(editor);
    ...
    if ($_b6olzc82jcgfo3fz.shouldAutoResizeOnInit(editor)) {
      editor.on('init', function () {
  ...
  var register = function (editor, oldSize) {
    editor.addCommand('mceAutoResize', function () {
      $_3xlra97zjcgfo3fu.resize(editor, oldSize);
    });
  };
  var $_dybhzs7yjcgfo3fs = { register: register };

  PluginManager.add('autoresize', function (editor) {
    if (!editor.inline) {
      var oldSize = Cell(0);
      $_dybhzs7yjcgfo3fs.register(editor, oldSize);
      $_3xlra97zjcgfo3fu.setup(editor, oldSize);
    }
  });
  var Plugin = function () {
  };
