...
var contextmenu = (function () {
  ...
  var $_bfbhkg9sjcgfo3nw = { getPos: getPos };
  ...
  var renderMenu = function (editor, visibleState) {
    ...
    var items = [];
    contextmenu = $_fbotz59rjcgfo3nu.getContextMenu(editor);
  ...
  var $_57d9py9vjcgfo3o0 = { show: show };

  var isNativeOverrideKeyEvent = function (editor, e) {
    return e.ctrlKey && !$_fbotz59rjcgfo3nu.shouldNeverUseNative(editor);
  };
  var setup = function (editor, visibleState, menu) {
    editor.on('contextmenu', function (e) {
      ...
      e.preventDefault();
      $_57d9py9vjcgfo3o0.show(editor, $_bfbhkg9sjcgfo3nw.getPos(editor, e), visibleState, menu);
    });
  };
  var $_1rclvg9qjcgfo3ns = { setup: setup };

  PluginManager.add('contextmenu', function (editor) {
    var menu = Cell(null), visibleState = Cell(false);
    $_1rclvg9qjcgfo3ns.setup(editor, visibleState, menu);
    return $_8brrxk9pjcgfo3nq.get(visibleState);
  });
  var Plugin = function () {
  };
