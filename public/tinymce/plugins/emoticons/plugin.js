...
var emoticons = (function () {
  ...
  var $_4suwq4a7jcgfo3p8 = { getHtml: getHtml };
  ...
  var register = function (editor, pluginUrl) {
    var panelHtml = $_4suwq4a7jcgfo3p8.getHtml(pluginUrl);
  ...
  var $_8fecraa6jcgfo3p5 = { register: register };

  PluginManager.add('emoticons', function (editor, pluginUrl) {
    $_8fecraa6jcgfo3p5.register(editor, pluginUrl);
  });
  var Plugin = function () {
  };
