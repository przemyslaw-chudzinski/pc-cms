...
var importcss = (function () {
  ...
  var defaultConvertSelectorToFormat = function (editor, selectorText) {
    ...
    if ($_64mzr7dvjcgfo4c5.shouldMergeClasses(editor) !== false) {
  ...
  var isExclusiveMode = function (editor, group) {
    return group === null || $_64mzr7dvjcgfo4c5.shouldImportExclusive(editor) !== false;
  };
  ...
  var convertSelectorToFormat = function (editor, plugin, selector, group) {
    ...
    } else if ($_64mzr7dvjcgfo4c5.getSelectorConverter(editor)) {
      selectorConverter = $_64mzr7dvjcgfo4c5.getSelectorConverter(editor);
    } else {
  ...
  var setup = function (editor) {
    editor.on('renderFormatsMenu', function (e) {
      ...
      var selectorFilter = compileFilter($_64mzr7dvjcgfo4c5.getSelectorFilter(editor)), ctrl = e.control;
      var groups = compileUserDefinedGroups($_64mzr7dvjcgfo4c5.getCssGroups(editor));
      ...
      if (!$_64mzr7dvjcgfo4c5.shouldAppend(editor)) {
        ctrl.items().remove();
      }
      Tools.each(getSelectors(editor, e.doc || editor.getDoc(), compileFilter($_64mzr7dvjcgfo4c5.getFileFilter(editor))), function (selector) {
  ...
  var get = function (editor) {
    var convertSelectorToFormat = function (selectorText) {
      return $_9d6apydqjcgfo4by.defaultConvertSelectorToFormat(editor, selectorText);
    };
    return { convertSelectorToFormat: convertSelectorToFormat };
  };
  var $_d5vvywdpjcgfo4bu = { get: get };

  PluginManager.add('importcss', function (editor) {
    $_9d6apydqjcgfo4by.setup(editor);
    return $_d5vvywdpjcgfo4bu.get(editor);
  });
  var Plugin = function () {
  };
