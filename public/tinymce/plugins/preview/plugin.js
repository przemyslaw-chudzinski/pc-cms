...
var preview = (function () {
  ...
  var getPreviewHtml = function (editor) {
    ...
    var contentStyle = $_fgc05hvjcgfo4tv.getContentStyle(editor);
  ...
  var open = function (editor) {
    ...
    var dialogWidth = $_fgc05hvjcgfo4tv.getPreviewDialogWidth(editor);
    var dialogHeight = $_fgc05hvjcgfo4tv.getPreviewDialogHeight(editor);
    editor.windowManager.open({
      ...
      onPostRender: function (e) {
        ...
        $_a97mf9hwjcgfo4tx.injectIframeContent(editor, iframeElm, sandbox);
      }
    });
  };
  var $_brrufahtjcgfo4tt = { open: open };

  var register = function (editor) {
    editor.addCommand('mcePreview', function () {
      $_brrufahtjcgfo4tt.open(editor);
    });
  };
  var $_5s36sfhsjcgfo4tq = { register: register };
  ...
  var $_92252khyjcgfo4u1 = { register: register$1 };

  PluginManager.add('preview', function (editor) {
    $_5s36sfhsjcgfo4tq.register(editor);
    $_92252khyjcgfo4u1.register(editor);
  });
  var Plugin = function () {
  };
