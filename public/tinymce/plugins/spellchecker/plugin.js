...
var spellchecker = (function () {
  ...
  var $_a1zz54iojcgfo4xf = { hasProPlugin: hasProPlugin };
  ...
  var defaultSpellcheckCallback = function (editor, pluginUrl, currentLanguageState) {
    return function (method, text, doneCallback, errorCallback) {
      ...
      XHR.send({
        url: new URI(pluginUrl).toAbsolute($_fah9o7iqjcgfo4xk.getRpcUrl(editor)),
        type: 'post',
        ...
        error: function () {
          var message = editor.translate('The spelling service was not found: (') + $_fah9o7iqjcgfo4xk.getRpcUrl(editor) + editor.translate(')');
          errorCallback(message);
        }
      });
    };
  ...
  var sendRpcCall = function (editor, pluginUrl, currentLanguageState, name, data, successCallback, errorCallback) {
    var userSpellcheckCallback = $_fah9o7iqjcgfo4xk.getSpellcheckerCallback(editor);
  ...
  var finish = function (editor, startedState, textMatcherState) {
    ...
    if (startedState.get()) {
      ...
      $_6e07ujivjcgfo51n.fireSpellcheckEnd(editor);
      return true;
    }
  };
  ...
  var markErrors = function (editor, startedState, textMatcherState, lastSuggestionsState, data) {
    ...
    getTextMatcher(editor, textMatcherState).find($_fah9o7iqjcgfo4xk.getSpellcheckerWordcharPattern(editor)).filter(function (match) {
    ...
    $_6e07ujivjcgfo51n.fireSpellcheckStart(editor);
  };
  var $_bal48sirjcgfo4xn = {
  ...
  var get = function (editor, startedState, lastSuggestionsState, textMatcherState, url) {
    var getLanguage = function () {
      return $_fah9o7iqjcgfo4xk.getLanguage(editor);
    };
    var getWordCharPattern = function () {
      return $_fah9o7iqjcgfo4xk.getSpellcheckerWordcharPattern(editor);
    };
    var markErrors = function (data) {
      $_bal48sirjcgfo4xn.markErrors(editor, startedState, textMatcherState, lastSuggestionsState, data);
    };
  ...
  var $_8b7y6yipjcgfo4xi = { get: get };

  var register = function (editor, pluginUrl, startedState, textMatcherState, lastSuggestionsState, currentLanguageState) {
    editor.addCommand('mceSpellCheck', function () {
      $_bal48sirjcgfo4xn.spellcheck(editor, pluginUrl, startedState, textMatcherState, lastSuggestionsState, currentLanguageState);
    });
  };
  var $_d9uy12ixjcgfo520 = { register: register };
  ...
  var updateSelection = function (editor) {
    return function (e) {
      var selectedLanguage = $_fah9o7iqjcgfo4xk.getLanguage(editor);
  ...
  var getItems = function (editor) {
    return Tools.map($_fah9o7iqjcgfo4xk.getLanguages(editor).split(','), function (langPair) {
  ...
  var $_6k3u7riyjcgfo523 = { register: register$1 };
  ...
  var showSuggestions = function (editor, pluginUrl, lastSuggestionsState, startedState, textMatcherState, word, spans) {
    ...
    Tools.each(suggestions, function (suggestion) {
      items.push({
        ...
        onclick: function () {
          ...
          $_bal48sirjcgfo4xn.checkIfFinished(editor, startedState, textMatcherState);
        }
      });
    });
    items.push({ text: '-' });
    ...
    if (hasDictionarySupport) {
      items.push({
        ...
        onclick: function () {
          $_bal48sirjcgfo4xn.addToDictionary(editor, pluginUrl, startedState, textMatcherState, word, spans);
        }
      });
    }
    items.push.apply(items, [
      {
        text: 'Ignore',
        onclick: function () {
          $_bal48sirjcgfo4xn.ignoreWord(editor, startedState, textMatcherState, word, spans);
        }
      },
      {
        text: 'Ignore all',
        onclick: function () {
          $_bal48sirjcgfo4xn.ignoreWord(editor, startedState, textMatcherState, word, spans, true);
        }
      }
    ]);
  ...
  var setup = function (editor, pluginUrl, lastSuggestionsState, startedState, textMatcherState) {
    editor.on('click', function (e) {
      ...
      if (target.className === 'mce-spellchecker-word') {
        e.preventDefault();
        var spans = $_bal48sirjcgfo4xn.findSpansByIndex(editor, $_bal48sirjcgfo4xn.getElmIndex(target));
        if (spans.length > 0) {
          var rng = editor.dom.createRng();
  ...
  var $_5ak79nizjcgfo528 = { setup: setup };

  PluginManager.add('spellchecker', function (editor, pluginUrl) {
    if ($_a1zz54iojcgfo4xf.hasProPlugin(editor) === false) {
      var startedState = Cell(false);
      var currentLanguageState = Cell($_fah9o7iqjcgfo4xk.getLanguage(editor));
      var textMatcherState = Cell(null);
      var lastSuggestionsState = Cell({});
      $_6k3u7riyjcgfo523.register(editor, pluginUrl, startedState, textMatcherState, currentLanguageState, lastSuggestionsState);
      $_5ak79nizjcgfo528.setup(editor, pluginUrl, lastSuggestionsState, startedState, textMatcherState);
      $_d9uy12ixjcgfo520.register(editor, pluginUrl, startedState, textMatcherState, lastSuggestionsState, currentLanguageState);
      return $_8b7y6yipjcgfo4xi.get(editor, startedState, lastSuggestionsState, textMatcherState, pluginUrl);
    }
  });
  var Plugin = function () {
  };
