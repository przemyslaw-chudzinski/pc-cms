...
var tabfocus = (function () {
  ...
  var $_5poepvjbjcgfo53v = { getTabFocus: getTabFocus };
  ...
  var setup = function (editor) {
    function tabHandler(e) {
      ...
      v = Tools.explode($_5poepvjbjcgfo53v.getTabFocus(editor));
      if (v.length === 1) {
        v[1] = v[0];
        v[0] = ':prev';
      }
  ...
  var $_bfp7ebj4jcgfo53o = { setup: setup };

  PluginManager.add('tabfocus', function (editor) {
    $_bfp7ebj4jcgfo53o.setup(editor);
  });
  var Plugin = function () {
  };
