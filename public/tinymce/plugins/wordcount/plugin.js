...
var wordcount = (function () {
  ...
  var $_45nx5grqjcgfo7ob = {
    each: each,
    map: map
  };

  var SETS$1 = $_6rydp5rojcgfo7o5.SETS;
  var OTHER = $_6rydp5rojcgfo7o5.characterIndices.OTHER;
  ...
  var classify = function (string) {
    ...
    return $_45nx5grqjcgfo7ob.map(string.split(''), memoized);
  };
  var $_29qnemrpjcgfo7o8 = { classify: classify };

  var ci = $_6rydp5rojcgfo7o5.characterIndices;
  ...
  var $_49s6jrrrjcgfo7oe = { isWordBoundary: isWordBoundary };

  var EMPTY_STRING = $_6rydp5rojcgfo7o5.EMPTY_STRING;
  var WHITESPACE = $_6rydp5rojcgfo7o5.WHITESPACE;
  var PUNCTUATION = $_6rydp5rojcgfo7o5.PUNCTUATION;
  ...
  var doGetWords = function (str, options) {
    var i = 0;
    var map = $_29qnemrpjcgfo7o8.classify(str);
    var len = map.length;
    var word = [];
    var words = [];
    var chr;
    ...
    for (; i < len; ++i) {
      chr = str.charAt(i);
      word.push(chr);
      if ($_49s6jrrrjcgfo7oe.isWordBoundary(map, i)) {
  ...
  var $_3zsy57rnjcgfo7o1 = { getWords: getWords };

  var getTextContent = function (editor) {
    return editor.removed ? '' : editor.getBody().innerText;
  };
  var getCount = function (editor) {
    return $_3zsy57rnjcgfo7o1.getWords(getTextContent(editor)).length;
  };
  var $_4huc6crmjcgfo7nz = { getCount: getCount };

  var get = function (editor) {
    var getCount = function () {
      return $_4huc6crmjcgfo7nz.getCount(editor);
    };
    return { getCount: getCount };
  };
  var $_6zigxprljcgfo7nx = { get: get };
  ...
  var setup = function (editor) {
    var wordsToText = function (editor) {
      return I18n.translate([
        '{0} words',
        $_4huc6crmjcgfo7nz.getCount(editor)
      ]);
    };
    var update = function () {
  ...
  var $_39kaxlrsjcgfo7oh = { setup: setup };

  PluginManager.add('wordcount', function (editor) {
    $_39kaxlrsjcgfo7oh.setup(editor);
    return $_6zigxprljcgfo7nx.get(editor);
  });
  var Plugin = function () {
  };
