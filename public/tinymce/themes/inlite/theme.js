...
var inlite = (function () {
  ...
  var $_3c1uhh164jcgfocgy = { flatten: flatten };
  ...
  var getSelectionRect = function (editor) {
    ...
    return clientRect ? toAbsolute($_9cff4d168jcgfoch7.fromClientRect(clientRect)) : null;
  };
  var $_7buh89167jcgfoch5 = {
    ...
    return function (editor) {
      for (var i = 0; i < predicateIds.length; i++) {
        if (predicateIds[i].predicate(element)) {
          return $_9cwxd5166jcgfoch3.result(predicateIds[i].id, $_7buh89167jcgfoch5.getElementRect(editor, element));
        }
      }
      return null;
    };
      ...
      for (var i = 0; i < elements.length; i++) {
        for (var x = 0; x < predicateIds.length; x++) {
          if (predicateIds[x].predicate(elements[i])) {
            return $_9cwxd5166jcgfoch3.result(predicateIds[x].id, $_7buh89167jcgfoch5.getElementRect(editor, elements[i]));
          }
        }
      }
      return null;
  ...
  var textSelection = function (id) {
    return function (editor) {
      if (!editor.selection.isCollapsed()) {
        return $_9cwxd5166jcgfoch3.result(id, $_7buh89167jcgfoch5.getSelectionRect(editor));
      }
      return null;
    };
  };
  ...
  var itemsToArray = function (value, defaultValue) {
    ...
    if ($_btljyr16hjcgfochy.isArray(value)) {
      return value;
    } else if ($_btljyr16hjcgfochy.isString(value)) {
      return stringToItemsArray(value);
    } else if ($_btljyr16hjcgfochy.isBoolean(value)) {
  ...
  var $_6zv40j16gjcgfochv = {
    getStringOr: getByTypeOr($_btljyr16hjcgfochy.isString),
    getBoolOr: getByTypeOr($_btljyr16hjcgfochy.isBoolean),
    getNumberOr: getByTypeOr($_btljyr16hjcgfochy.isNumber),
    getHandlerOr: getByTypeOr($_btljyr16hjcgfochy.isFunction),
    getToolbarItemsOr: getToolbarItemsOr($_btljyr16hjcgfochy.isArray)
  };
  ...
  var userConstrain = function (handler, targetRect, contentAreaRect, panelRect) {
    ...
    if (typeof handler === 'function') {
      userConstrainedPanelRect = handler({
        elementRect: $_9cff4d168jcgfoch7.toClientRect(targetRect),
        contentAreaRect: $_9cff4d168jcgfoch7.toClientRect(contentAreaRect),
        panelRect: $_9cff4d168jcgfoch7.toClientRect(panelRect)
      });
      return $_9cff4d168jcgfoch7.fromClientRect(userConstrainedPanelRect);
    }
    return panelRect;
  };
  ...
  var getTextSelectionToolbarItems = function (editor) {
    return $_6zv40j16gjcgfochv.getToolbarItemsOr(editor, 'selection_toolbar', [
      'bold',
      'italic',
      '|',
      'quicklink',
  ...
  var getInsertToolbarItems = function (editor) {
    return $_6zv40j16gjcgfochv.getToolbarItemsOr(editor, 'insert_toolbar', [
      'quickimage',
      'quicktable'
    ]);
  };
  var getPositionHandler = function (editor) {
    return $_6zv40j16gjcgfochv.getHandlerOr(editor, 'inline_toolbar_position_handler', $_4inand16ijcgfoci0.defaultHandler);
  };
  ...
  var fireSkinLoaded = function (editor, callback) {
    var done = function () {
      ...
      $_7zxvb316djcgfochh.fireSkinLoaded(editor);
      callback();
    };
  ...
  var load = function (editor, callback) {
    var skinUrl = $_fsa68b16ejcgfochk.getSkinUrl(editor);
    var done = function () {
      fireSkinLoaded(editor, callback);
    };
    if ($_fsa68b16ejcgfochk.isSkinDisabled(editor)) {
      done();
    } else {
  ...
  var $_e4zivm16cjcgfochf = { load: load };
  ...
  var getToolbars = function (editor) {
    ...
    return $_3c1uhh164jcgfocgy.flatten([
  ...
  var findMatchResult = function (editor, toolbars) {
    ...
    contextToolbarsPredicateIds = $_7q5712169jcgfocha.fromContextToolbars(toolbars);
    result = $_9cwxd5166jcgfoch3.match(editor, [
      $_2a49b1165jcgfoch0.element(elements[0], contextToolbarsPredicateIds),
      $_a01k4o16bjcgfochc.textSelection('text'),
      $_a01k4o16bjcgfochc.emptyTextBlock(elements, 'insert'),
      $_2a49b1165jcgfoch0.parent(elements, contextToolbarsPredicateIds)
    ]);
  ...
  var overrideLinkShortcut = function (editor, panel) {
    ...
    editor.shortcuts.add('meta+k', '', function () {
      var toolbars = getToolbars(editor);
      var result = $_9cwxd5166jcgfoch3.match(editor, [$_a01k4o16bjcgfochc.textSelection('quicklink')]);
      if (result) {
        panel.show(editor, result.id, result.rect, toolbars);
      }
    });
  ...
  var renderInlineUI = function (editor, panel) {
    $_e4zivm16cjcgfochf.load(editor, function () {
  ...
  var $_6pmbse160jcgfocgt = { renderUI: renderUI };
  ...
  var never = $_23g2ob16njcgfocj8.never;
  var always = $_23g2ob16njcgfocj8.always;
  var none = function () {
    return NONE;
  };
  var NONE = function () {
    ...
    var me = {
      ...
      toString: $_23g2ob16njcgfocj8.constant('none()')
    };
    if (Object.freeze)
      Object.freeze(me);
    return me;
  ...
  var indexOf = function (xs, x) {
    ...
    return r === -1 ? $_b4b17x16mjcgfocip.none() : $_b4b17x16mjcgfocip.some(r);
  };
  ...
  var find = function (xs, pred) {
    for (var i = 0, len = xs.length; i < len; i++) {
      var x = xs[i];
      if (pred(x, i, xs)) {
        return $_b4b17x16mjcgfocip.some(x);
      }
    }
    return $_b4b17x16mjcgfocip.none();
  };
  var findIndex = function (xs, pred) {
    for (var i = 0, len = xs.length; i < len; i++) {
      var x = xs[i];
      if (pred(x, i, xs)) {
        return $_b4b17x16mjcgfocip.some(i);
      }
    }
    return $_b4b17x16mjcgfocip.none();
  };
  ...
  var head = function (xs) {
    return xs.length === 0 ? $_b4b17x16mjcgfocip.none() : $_b4b17x16mjcgfocip.some(xs[0]);
  };
  var last = function (xs) {
    return xs.length === 0 ? $_b4b17x16mjcgfocip.none() : $_b4b17x16mjcgfocip.some(xs[xs.length - 1]);
  };
  var $_f9szz16ljcgfocii = {
    map: map,
    each: each,
    eachr: eachr,
    partition: partition,
  ...
  var proto = {
    ...
    init: function (settings) {
      ...
      self.borderBox = $_2lvb8516ujcgfockh.parseBox(settings.border);
      self.paddingBox = $_2lvb8516ujcgfockh.parseBox(settings.padding);
      self.marginBox = $_2lvb8516ujcgfockh.parseBox(settings.margin);
      if (settings.hidden) {
        self.hide();
      }
    },
    ...
    initLayoutRect: function () {
      ...
      borderBox = self.borderBox = self.borderBox || $_2lvb8516ujcgfockh.measureBox(elm, 'border');
      self.paddingBox = self.paddingBox || $_2lvb8516ujcgfockh.measureBox(elm, 'padding');
      self.marginBox = self.marginBox || $_2lvb8516ujcgfockh.measureBox(elm, 'margin');
    ...
    reflow: function () {
      $_60cq39171jcgfocl7.remove(this);
  ...
  var NotificationManagerImpl = function (editor) {
    ...
    var prePositionNotifications = function (notifications) {
      $_f9szz16ljcgfocii.each(notifications, function (notification) {
    ...
    var positionNotifications = function (notifications) {
      if (notifications.length > 0) {
        ...
        $_f9szz16ljcgfocii.each(notifications, function (notification, index) {
          if (index > 0) {
  ...
  var Window = FloatPanel.extend({
    ...
    fullscreen: function (state) {
      ...
      if (state !== self._fullscreen) {
        ...
        if (!state) {
          self.borderBox = $_2lvb8516ujcgfockh.parseBox(self.settings.border);
          ...
          self.borderBox = $_2lvb8516ujcgfockh.parseBox('0');
  ...
  var get = function (editor, panel) {
    var renderUI = function () {
      return $_6pmbse160jcgfocgt.renderUI(editor, panel);
    };
    return {
      renderUI: renderUI,
  ...
  var $_e4y94h15zjcgfocgq = { get: get };
  ...
  var unsafe = function (name, scope) {
    return $_2moaiy17ljcgfocob.resolve(name, scope);
  };
  ...
  var $_c9e1tm17kjcgfoco2 = { getOrDie: getOrDie };

  var FileReader = function () {
    var f = $_c9e1tm17kjcgfoco2.getOrDie('FileReader');
    return new f();
  };
  ...
  var $_7s2zs17ijcgfocnp = { blobToBase64: blobToBase64 };
  ...
  var $_2x3l8117ojcgfocoi = { pickFile: pickFile };
  ...
  var $_d53zvr17qjcgfocoq = { uuid: uuid };
  ...
  var unwrapElements = function (editor, elms) {
    ...
    bookmark = $_bdz76e17sjcgfocq6.create(dom, selection.getRng());
    Tools.each(elms, function (elm) {
      editor.dom.remove(elm, true);
    });
    selection.setRng($_bdz76e17sjcgfocq6.resolve(dom, bookmark));
  };
  ...
  var $_f7430817rjcgfocot = { unlinkSelection: unlinkSelection };
  ...
  var insertBlob = function (editor, base64, blob) {
    ...
    blobInfo = blobCache.create($_d53zvr17qjcgfocoq.uuid('mceu'), blob, base64);
  ...
  var unlink = function (editor) {
    editor.focus();
    $_f7430817rjcgfocot.unlinkSelection(editor);
  ...
  var addHeaderButtons = function (editor) {
    var formatBlock = function (name) {
      return function () {
        $_f9bbj617pjcgfocom.formatBlock(editor, name);
      };
    };
    for (var i = 1; i < 6; i++) {
      var name_1 = 'h' + i;
  ...
  var addToEditor = function (editor, panel) {
    ...
    editor.addButton('quickimage', {
      ...
      onclick: function () {
        $_2x3l8117ojcgfocoi.pickFile().then(function (files) {
          var blob = files[0];
          $_7s2zs17ijcgfocnp.blobToBase64(blob).then(function (base64) {
            $_f9bbj617pjcgfocom.insertBlob(editor, base64, blob);
          });
        });
      }
    });
    editor.addButton('quicktable', {
      ...
      onclick: function () {
        panel.hide();
        $_f9bbj617pjcgfocom.insertTable(editor, 2, 2);
      }
    });
    addHeaderButtons(editor);
  };
  var $_fvtyc717hjcgfocnm = { addToEditor: addToEditor };
  ...
  var getUiContainerDelta = function () {
    ...
    if (uiContainer && DOMUtils.DOM.getStyle(uiContainer, 'position', true) !== 'static') {
      ...
      return $_b4b17x16mjcgfocip.some({
        x: dx,
        y: dy
      });
    } else {
  ...
  var $_3sjxb817wjcgfocrg = { getUiContainerDelta: getUiContainerDelta };
  ...
  var convertLinkToAbsolute = function (editor, href) {
    return !$_a0d7tl17yjcgfocrs.isAbsolute(href) && $_a0d7tl17yjcgfocrs.isDomainLike(href) ? askAboutPrefix(editor, href) : Promise.resolve(href);
  };
  var createQuickLinkForm = function (editor, hide) {
    var attachState = {};
    var unlink = function () {
      editor.focus();
      $_f9bbj617pjcgfocom.unlink(editor);
      hide();
    };
      ...
      onsubmit: function (e) {
        convertLinkToAbsolute(editor, e.data.linkurl).then(function (url) {
          editor.undoManager.transact(function () {
            ...
            $_f9bbj617pjcgfocom.createLink(editor, url);
          });
          hide();
        });
      }
  ...
  var $_64cw7t17xjcgfocro = { createQuickLinkForm: createQuickLinkForm };
  ...
  var itemsToArray$1 = function (items) {
    if ($_btljyr16hjcgfochy.isArray(items)) {
      return items;
    } else if ($_btljyr16hjcgfochy.isString(items)) {
      return items.split(/[ ,]/);
    }
    return [];
  };
  ...
  var $_dxletp17zjcgfocru = { create: create$2 };

  var Panel$1 = function () {
    var panel, currentRect;
    var createToolbars = function (editor, toolbars) {
      return Tools.map(toolbars, function (toolbar) {
        return $_dxletp17zjcgfocru.create(editor, toolbar.id, toolbar.items);
      });
    };
    ...
    var create = function (editor, toolbars) {
      var items = createToolbars(editor, toolbars).concat([
        $_dxletp17zjcgfocru.create(editor, 'text', $_fsa68b16ejcgfochk.getTextSelectionToolbarItems(editor)),
        $_dxletp17zjcgfocru.create(editor, 'insert', $_fsa68b16ejcgfochk.getInsertToolbarItems(editor)),
        $_64cw7t17xjcgfocro.createQuickLinkForm(editor, hide)
      ]);
      return Factory.create({
        type: 'floatpanel',
        role: 'dialog',
    ...
    var repositionPanelAt = function (panel, id, editor, targetRect) {
      ...
      userConstainHandler = $_fsa68b16ejcgfochk.getPositionHandler(editor);
      contentAreaRect = $_7buh89167jcgfoch5.getContentAreaRect(editor);
      panelRect = DOMUtils.DOM.getRect(panel.getEl());
      if (id === 'insert') {
        result = $_4inand16ijcgfoci0.calcInsert(targetRect, contentAreaRect, panelRect);
      } else {
        result = $_4inand16ijcgfoci0.calc(targetRect, contentAreaRect, panelRect);
      }
      if (result) {
        var delta = $_3sjxb817wjcgfocrg.getUiContainerDelta().getOr({
          x: 0,
          y: 0
        });
        ...
        movePanelTo(panel, $_4inand16ijcgfoci0.userConstrain(userConstainHandler, targetRect, contentAreaRect, transposedPanelRect));
    ...
    var showForm = function (editor, id) {
      if (panel) {
        ...
        contentAreaRect = $_7buh89167jcgfoch5.getContentAreaRect(editor);
        panelRect = DOMUtils.DOM.getRect(panel.getEl());
        result = $_4inand16ijcgfoci0.calc(currentRect, contentAreaRect, panelRect);
        if (result) {
          panelRect = result.rect;
          movePanelTo(panel, $_4inand16ijcgfoci0.userConstrain(userConstainHandler, currentRect, contentAreaRect, panelRect));
          togglePositionClass(panel, result.position);
        }
      }
    };
    var show = function (editor, id, targetRect, toolbars) {
      if (!panel) {
        $_7zxvb316djcgfochh.fireBeforeRenderUI(editor);
  ...
  var $_e1i8j918mjcgfocyv = { generate: generate };
  ...
  var fromDom = function (node) {
    ...
    return { dom: $_23g2ob16njcgfocj8.constant(node) };
  };
  var fromPoint = function (doc, x, y) {
    return $_b4b17x16mjcgfocip.from(doc.dom().elementFromPoint(x, y)).map(fromDom);
  };
  var $_ennn6d18njcgfocyy = {
    fromHtml: fromHtml,
    fromTag: fromTag,
    fromText: fromText,
    fromDom: fromDom,
  ...
  var $_eqtkss18rjcgfod1g = { cached: cached };

  var $_ayp9ca18tjcgfod1l = {
    ATTRIBUTE: 2,
    CDATA_SECTION: 4,
    COMMENT: 8,
    DOCUMENT: 9,
  ...
  var isComment = function (element) {
    return type(element) === $_ayp9ca18tjcgfod1l.COMMENT || name(element) === '#comment';
  };
  var isElement = isType$1($_ayp9ca18tjcgfod1l.ELEMENT);
  var isText = isType$1($_ayp9ca18tjcgfod1l.TEXT);
  var isDocument = isType$1($_ayp9ca18tjcgfod1l.DOCUMENT);
  var $_cspiqz18sjcgfod1i = {
    name: name,
    type: type,
    value: value,
    isElement: isElement,
  ...
  var inBody = function (element) {
    var dom = $_cspiqz18sjcgfod1i.isText(element) ? element.dom().parentNode : element.dom();
    return dom !== undefined && dom !== null && dom.ownerDocument.body.contains(dom);
  };
  var body = $_eqtkss18rjcgfod1g.cached(function () {
    return getBody($_ennn6d18njcgfocyy.fromDom(document));
  });
  var getBody = function (doc) {
    var body = doc.dom().body;
    if (body === null || body === undefined)
      throw 'Body is not available yet';
    return $_ennn6d18njcgfocyy.fromDom(body);
  };
  var $_ej2axm18qjcgfod19 = {
    body: body,
    getBody: getBody,
    inBody: inBody
  };
  ...
  var Immutable = function () {
    ...
    return function () {
      ...
      var struct = {};
      $_f9szz16ljcgfocii.each(fields, function (name, i) {
        struct[name] = $_23g2ob16njcgfocj8.constant(values[i]);
      });
      return struct;
    };
  };
  ...
  var validateStrArr = function (label, array) {
    if (!$_d6n9bs18vjcgfod42.isArray(array))
      throw new Error('The ' + label + ' fields must be an array. Was: ' + array + '.');
    $_f9szz16ljcgfocii.each(array, function (a) {
      if (!$_d6n9bs18vjcgfod42.isString(a))
  ...
  var checkDupes = function (everything) {
    ...
    var dupe = $_f9szz16ljcgfocii.find(sorted, function (s, i) {
  ...
  var MixedBag = function (required, optional) {
    ...
    $_49bndy190jcgfod4k.validateStrArr('required', required);
    $_49bndy190jcgfod4k.validateStrArr('optional', optional);
    $_49bndy190jcgfod4k.checkDupes(everything);
    return function (obj) {
      var keys = $_1ykao18zjcgfod4f.keys(obj);
      var allReqd = $_f9szz16ljcgfocii.forall(required, function (req) {
        return $_f9szz16ljcgfocii.contains(keys, req);
      });
      if (!allReqd)
        $_49bndy190jcgfod4k.reqMessage(required, keys);
      var unsupported = $_f9szz16ljcgfocii.filter(keys, function (key) {
        return !$_f9szz16ljcgfocii.contains(everything, key);
      });
      if (unsupported.length > 0)
        $_49bndy190jcgfod4k.unsuppMessage(unsupported);
      var r = {};
      $_f9szz16ljcgfocii.each(required, function (req) {
        r[req] = $_23g2ob16njcgfocj8.constant(obj[req]);
      });
      $_f9szz16ljcgfocii.each(optional, function (opt) {
        r[opt] = $_23g2ob16njcgfocj8.constant(Object.prototype.hasOwnProperty.call(obj, opt) ? $_b4b17x16mjcgfocip.some(obj[opt]) : $_b4b17x16mjcgfocip.none());
      });
      return r;
    };
  };

  var $_80nekn18wjcgfod46 = {
    immutable: Immutable,
  ...
  var $_bsoyr3191jcgfod4q = { toArray: toArray };

  var node = function () {
    var f = $_c9e1tm17kjcgfoco2.getOrDie('Node');
    return f;
  };
  ...
  var unknown = function () {
    return nu({
      current: undefined,
      version: $_5xzkzk197jcgfod7g.unknown()
    });
  };
  ...
  var $_pjhva196jcgfod5y = {
    unknown: unknown,
    nu: nu,
    edge: $_23g2ob16njcgfocj8.constant(edge),
    chrome: $_23g2ob16njcgfocj8.constant(chrome),
    ie: $_23g2ob16njcgfocj8.constant(ie),
    opera: $_23g2ob16njcgfocj8.constant(opera),
    firefox: $_23g2ob16njcgfocj8.constant(firefox),
    safari: $_23g2ob16njcgfocj8.constant(safari)
  };
  ...
  var $_7a9fmr198jcgfod7j = {
    unknown: unknown$2,
    nu: nu$2,
    windows: $_23g2ob16njcgfocj8.constant(windows$1),
    ios: $_23g2ob16njcgfocj8.constant(ios),
    android: $_23g2ob16njcgfocj8.constant(android),
    linux: $_23g2ob16njcgfocj8.constant(linux),
    osx: $_23g2ob16njcgfocj8.constant(osx),
    solaris: $_23g2ob16njcgfocj8.constant(solaris),
    freebsd: $_23g2ob16njcgfocj8.constant(freebsd)
  };
  ...
  var DeviceType = function (os, browser, userAgent) {
    ...
    return {
      isiPad: $_23g2ob16njcgfocj8.constant(isiPad),
      isiPhone: $_23g2ob16njcgfocj8.constant(isiPhone),
      isTablet: $_23g2ob16njcgfocj8.constant(isTablet),
      isPhone: $_23g2ob16njcgfocj8.constant(isPhone),
      isTouch: $_23g2ob16njcgfocj8.constant(isTouch),
      isAndroid: os.isAndroid,
      isiOS: os.isiOS,
      isWebView: $_23g2ob16njcgfocj8.constant(iOSwebview)
    };
  };

  var detect$3 = function (candidates, userAgent) {
    var agent = String(userAgent).toLowerCase();
    return $_f9szz16ljcgfocii.find(candidates, function (candidate) {
      return candidate.search(agent);
    });
  };
  var detectBrowser = function (browsers, userAgent) {
    return detect$3(browsers, userAgent).map(function (browser) {
      var version = $_5xzkzk197jcgfod7g.detect(browser.versionRegexes, userAgent);
      return {
  ...
  var detectOs = function (oses, userAgent) {
    return detect$3(oses, userAgent).map(function (os) {
      var version = $_5xzkzk197jcgfod7g.detect(os.versionRegexes, userAgent);
      return {
        current: os.name,
        version: version
      };
  ...
  var head$1 = function (str) {
    return str === '' ? $_b4b17x16mjcgfocip.none() : $_b4b17x16mjcgfocip.some(str.substr(0, 1));
  };
  var tail = function (str) {
    return str === '' ? $_b4b17x16mjcgfocip.none() : $_b4b17x16mjcgfocip.some(str.substring(1));
  };
  var $_drygy19ejcgfod8w = {
    first: first,
    last: last$1,
    head: head$1,
    tail: tail
  ...
  var removeLeading = function (str, prefix) {
    return startsWith(str, prefix) ? $_dewnk419djcgfod8u.removeFromStart(str, prefix.length) : str;
  };
  var removeTrailing = function (str, prefix) {
    return endsWith(str, prefix) ? $_dewnk419djcgfod8u.removeFromEnd(str, prefix.length) : str;
  };
  var ensureLeading = function (str, prefix) {
    return startsWith(str, prefix) ? str : $_dewnk419djcgfod8u.addToStart(str, prefix);
  };
  var ensureTrailing = function (str, prefix) {
    return endsWith(str, prefix) ? str : $_dewnk419djcgfod8u.addToEnd(str, prefix);
  };
  var contains$2 = function (str, substr) {
    return str.indexOf(substr) !== -1;
  };
  var capitalize = function (str) {
    return $_drygy19ejcgfod8w.head(str).bind(function (head) {
      return $_drygy19ejcgfod8w.tail(str).map(function (tail) {
  ...
  var checkContains = function (target) {
    return function (uastring) {
      return $_brmytg19cjcgfod8h.contains(uastring, target);
    };
  };
  var browsers = [
    {
      ...
      search: function (uastring) {
        var monstrosity = $_brmytg19cjcgfod8h.contains(uastring, 'edge/') && $_brmytg19cjcgfod8h.contains(uastring, 'chrome') && $_brmytg19cjcgfod8h.contains(uastring, 'safari') && $_brmytg19cjcgfod8h.contains(uastring, 'applewebkit');
        return monstrosity;
      }
    },
    {
      ...
      search: function (uastring) {
        return $_brmytg19cjcgfod8h.contains(uastring, 'chrome') && !$_brmytg19cjcgfod8h.contains(uastring, 'chromeframe');
      }
    },
    {
      name: 'IE',
      ...
      search: function (uastring) {
        return $_brmytg19cjcgfod8h.contains(uastring, 'msie') || $_brmytg19cjcgfod8h.contains(uastring, 'trident');
      }
    },
    {
      name: 'Opera',
    ...
    },
    {
      ...
      search: function (uastring) {
        return ($_brmytg19cjcgfod8h.contains(uastring, 'safari') || $_brmytg19cjcgfod8h.contains(uastring, 'mobile/')) && $_brmytg19cjcgfod8h.contains(uastring, 'applewebkit');
      }
    }
  ];
  var oses = [
    ...
    },
    {
      name: 'iOS',
      search: function (uastring) {
        return $_brmytg19cjcgfod8h.contains(uastring, 'iphone') || $_brmytg19cjcgfod8h.contains(uastring, 'ipad');
      },
      versionRegexes: [
        /.*?version\/\ ?([0-9]+)\.([0-9]+).*/,
        /.*cpu os ([0-9]+)_([0-9]+).*/,
  ...
  var $_64486n19bjcgfod85 = {
    browsers: $_23g2ob16njcgfocj8.constant(browsers),
    oses: $_23g2ob16njcgfocj8.constant(oses)
  };

  var detect$1 = function (userAgent) {
    var browsers = $_64486n19bjcgfod85.browsers();
    var oses = $_64486n19bjcgfod85.oses();
    var browser = $_7wpc8219ajcgfod7y.detectBrowser(browsers, userAgent).fold($_pjhva196jcgfod5y.unknown, $_pjhva196jcgfod5y.nu);
    var os = $_7wpc8219ajcgfod7y.detectOs(oses, userAgent).fold($_7a9fmr198jcgfod7j.unknown, $_7a9fmr198jcgfod7j.nu);
  ...
  var $_czs1vw195jcgfod5u = { detect: detect$1 };

  var detect = $_eqtkss18rjcgfod1g.cached(function () {
    var userAgent = navigator.userAgent;
    return $_czs1vw195jcgfod5u.detect(userAgent);
  });
  var $_177ffq194jcgfod5o = { detect: detect };

  var ELEMENT = $_ayp9ca18tjcgfod1l.ELEMENT;
  var DOCUMENT = $_ayp9ca18tjcgfod1l.DOCUMENT;
  ...
  var all$2 = function (selector, scope) {
    ...
    return bypassSelector(base) ? [] : $_f9szz16ljcgfocii.map(base.querySelectorAll(selector), $_ennn6d18njcgfocyy.fromDom);
  };
  var one = function (selector, scope) {
    var base = scope === undefined ? document : scope.dom();
    return bypassSelector(base) ? $_b4b17x16mjcgfocip.none() : $_b4b17x16mjcgfocip.from(base.querySelector(selector)).map($_ennn6d18njcgfocyy.fromDom);
  };
  var $_3uqbk019fjcgfod99 = {
    all: all$2,
    is: is,
    one: one
  };
  ...
  var member = function (element, elements) {
    return $_f9szz16ljcgfocii.exists(elements, $_23g2ob16njcgfocj8.curry(eq, element));
  };
  ...
  var ieContains = function (e1, e2) {
    return $_2reovp193jcgfod5m.documentPositionContainedBy(e1.dom(), e2.dom());
  };
  var browser = $_177ffq194jcgfod5o.detect().browser;
  var contains$1 = browser.isIE() ? ieContains : regularContains;
  var $_e59kcc192jcgfod4t = {
    eq: eq,
    isEqualNode: isEqualNode,
    member: member,
    contains: contains$1,
    is: $_3uqbk019fjcgfod99.is
  };

  var owner = function (element) {
    return $_ennn6d18njcgfocyy.fromDom(element.dom().ownerDocument);
  };
  var documentElement = function (element) {
    var doc = owner(element);
    return $_ennn6d18njcgfocyy.fromDom(doc.dom().documentElement);
  };
  var defaultView = function (element) {
    var el = element.dom();
    var defaultView = el.ownerDocument.defaultView;
    return $_ennn6d18njcgfocyy.fromDom(defaultView);
  };
  var parent$1 = function (element) {
    var dom = element.dom();
    return $_b4b17x16mjcgfocip.from(dom.parentNode).map($_ennn6d18njcgfocyy.fromDom);
  };
  var findIndex$1 = function (element) {
    return parent$1(element).bind(function (p) {
      var kin = children$2(p);
      return $_f9szz16ljcgfocii.findIndex(kin, function (elem) {
        return $_e59kcc192jcgfod4t.eq(element, elem);
      });
    });
  };
  var parents = function (element, isRoot) {
    var stop = $_d6n9bs18vjcgfod42.isFunction(isRoot) ? isRoot : $_23g2ob16njcgfocj8.constant(false);
    var dom = element.dom();
    var ret = [];
    while (dom.parentNode !== null && dom.parentNode !== undefined) {
      var rawParent = dom.parentNode;
      var parent = $_ennn6d18njcgfocyy.fromDom(rawParent);
      ret.push(parent);
      if (stop(parent) === true)
        break;
      else
  ...
  var siblings$2 = function (element) {
    var filterSelf = function (elements) {
      return $_f9szz16ljcgfocii.filter(elements, function (x) {
        return !$_e59kcc192jcgfod4t.eq(element, x);
      });
    };
  ...
  var offsetParent = function (element) {
    var dom = element.dom();
    return $_b4b17x16mjcgfocip.from(dom.offsetParent).map($_ennn6d18njcgfocyy.fromDom);
  };
  var prevSibling = function (element) {
    var dom = element.dom();
    return $_b4b17x16mjcgfocip.from(dom.previousSibling).map($_ennn6d18njcgfocyy.fromDom);
  };
  var nextSibling = function (element) {
    var dom = element.dom();
    return $_b4b17x16mjcgfocip.from(dom.nextSibling).map($_ennn6d18njcgfocyy.fromDom);
  };
  var prevSiblings = function (element) {
    return $_f9szz16ljcgfocii.reverse($_bsoyr3191jcgfod4q.toArray(element, prevSibling));
  };
  var nextSiblings = function (element) {
    return $_bsoyr3191jcgfod4q.toArray(element, nextSibling);
  };
  var children$2 = function (element) {
    var dom = element.dom();
    return $_f9szz16ljcgfocii.map(dom.childNodes, $_ennn6d18njcgfocyy.fromDom);
  };
  var child = function (element, index) {
    var children = element.dom().childNodes;
    return $_b4b17x16mjcgfocip.from(children[index]).map($_ennn6d18njcgfocyy.fromDom);
  };
  ...
  var spot = $_80nekn18wjcgfod46.immutable('element', 'offset');
  var leaf = function (element, offset) {
    var cs = children$2(element);
    return cs.length > 0 && offset < cs.length ? spot(cs[offset], 0) : spot(element, offset);
  };
  var $_d787cd18ujcgfod1p = {
    owner: owner,
  ...
  var all$1 = function (predicate) {
    return descendants$1($_ej2axm18qjcgfod19.body(), predicate);
  };
  var ancestors$1 = function (scope, predicate, isRoot) {
    return $_f9szz16ljcgfocii.filter($_d787cd18ujcgfod1p.parents(scope, isRoot), predicate);
  };
  var siblings$1 = function (scope, predicate) {
    return $_f9szz16ljcgfocii.filter($_d787cd18ujcgfod1p.siblings(scope), predicate);
  };
  var children$1 = function (scope, predicate) {
    return $_f9szz16ljcgfocii.filter($_d787cd18ujcgfod1p.children(scope), predicate);
  };
  var descendants$1 = function (scope, predicate) {
    var result = [];
    $_f9szz16ljcgfocii.each($_d787cd18ujcgfod1p.children(scope), function (x) {
      if (predicate(x)) {
  ...
  var all = function (selector) {
    return $_3uqbk019fjcgfod99.all(selector);
  };
  var ancestors = function (scope, selector, isRoot) {
    return $_4jk1tw18pjcgfod12.ancestors(scope, function (e) {
      return $_3uqbk019fjcgfod99.is(e, selector);
    }, isRoot);
  };
  var siblings = function (scope, selector) {
    return $_4jk1tw18pjcgfod12.siblings(scope, function (e) {
      return $_3uqbk019fjcgfod99.is(e, selector);
    });
  };
  var children = function (scope, selector) {
    return $_4jk1tw18pjcgfod12.children(scope, function (e) {
      return $_3uqbk019fjcgfod99.is(e, selector);
    });
  };
  var descendants = function (scope, selector) {
    return $_3uqbk019fjcgfod99.all(selector, scope);
  };
  var $_3cxn7x18ojcgfod0z = {
    all: all,
    ancestors: ancestors,
    siblings: siblings,
    children: children,
  ...
  var select = function (selector, root) {
    return $_f9szz16ljcgfocii.map($_3cxn7x18ojcgfod0z.descendants($_ennn6d18njcgfocyy.fromDom(root), selector), function (element) {
      return element.dom();
    });
  };
  ...
  var getOrGenerateId = function (elm) {
    return elm.id ? elm.id : $_e1i8j918mjcgfocyv.generate('h');
  };
  ...
  var anchorTarget = function (elm) {
    ...
    return create$3('anchor', anchorText ? anchorText : '#' + anchorId, '#' + anchorId, 0, $_23g2ob16njcgfocj8.noop);
  };
  var getHeaderTargets = function (elms) {
    return $_f9szz16ljcgfocii.map($_f9szz16ljcgfocii.filter(elms, isValidHeader), headerTarget);
  };
  var getAnchorTargets = function (elms) {
    return $_f9szz16ljcgfocii.map($_f9szz16ljcgfocii.filter(elms, isValidAnchor), anchorTarget);
  };
  ...
  var find$1 = function (elm) {
    ...
    return $_f9szz16ljcgfocii.filter(getHeaderTargets(elms).concat(getAnchorTargets(elms)), hasTitle);
  };
  var $_42s7it18ljcgfocya = { find: find$1 };
  ...
  var staticMenuItem = function (title, url) {
    return {
      ...
      value: {
        title: title,
        url: url,
        attach: $_23g2ob16njcgfocj8.noop
      }
    };
  };
  var isUniqueUrl = function (url, targets) {
    var foundTarget = $_f9szz16ljcgfocii.exists(targets, function (target) {
  ...
  var createMenuItems = function (term, targets, fileType, editorSettings) {
    ...
    var fromHistoryMenuItems = function (history) {
      ...
      var uniqueHistory = $_f9szz16ljcgfocii.filter(historyItems, function (url) {
    ...
    var fromMenuItems = function (type) {
      var filteredTargets = $_f9szz16ljcgfocii.filter(targets, function (target) {
    ...
    var join = function (items) {
      return $_f9szz16ljcgfocii.foldl(items, function (a, b) {
  ...
  var addToHistory = function (url, fileType) {
    ...
    if (items) {
      if ($_f9szz16ljcgfocii.indexOf(items, url) === -1) {
  ...
  var setupAutoCompleteHandler = function (ctrl, editorSettings, bodyElm, fileType) {
    var autocomplete = function (term) {
      var linkTargets = $_42s7it18ljcgfocya.find(bodyElm);
  ...
  var ClosestOrAncestor = function (is, ancestor, scope, a, isRoot) {
    return is(scope, a) ? $_b4b17x16mjcgfocip.some(scope) : $_d6n9bs18vjcgfod42.isFunction(isRoot) && isRoot(scope) ? $_b4b17x16mjcgfocip.none() : ancestor(scope, a, isRoot);
  };

  var first$2 = function (predicate) {
    return descendant$1($_ej2axm18qjcgfod19.body(), predicate);
  };
  var ancestor$1 = function (scope, predicate, isRoot) {
    ...
    while (element.parentNode) {
      ...
      var el = $_ennn6d18njcgfocyy.fromDom(element);
      if (predicate(el))
        return $_b4b17x16mjcgfocip.some(el);
      else if (stop(el))
        break;
    }
    return $_b4b17x16mjcgfocip.none();
  ...
  var sibling$1 = function (scope, predicate) {
    ...
    if (!element.parentNode)
      return $_b4b17x16mjcgfocip.none();
    return child$2($_ennn6d18njcgfocyy.fromDom(element.parentNode), function (x) {
      return !$_e59kcc192jcgfod4t.eq(scope, x) && predicate(x);
    });
  };
  var child$2 = function (scope, predicate) {
    var result = $_f9szz16ljcgfocii.find(scope.dom().childNodes, $_23g2ob16njcgfocj8.compose(predicate, $_ennn6d18njcgfocyy.fromDom));
    return result.map($_ennn6d18njcgfocyy.fromDom);
  };
  var descendant$1 = function (scope, predicate) {
    var descend = function (element) {
      for (var i = 0; i < element.childNodes.length; i++) {
        if (predicate($_ennn6d18njcgfocyy.fromDom(element.childNodes[i])))
          return $_b4b17x16mjcgfocip.some($_ennn6d18njcgfocyy.fromDom(element.childNodes[i]));
  ...
  var first$1 = function (selector) {
    return $_3uqbk019fjcgfod99.one(selector);
  };
  var ancestor = function (scope, selector, isRoot) {
    return $_5wrck919ljcgfodcn.ancestor(scope, function (e) {
      return $_3uqbk019fjcgfod99.is(e, selector);
    }, isRoot);
  };
  var sibling = function (scope, selector) {
    return $_5wrck919ljcgfodcn.sibling(scope, function (e) {
      return $_3uqbk019fjcgfod99.is(e, selector);
    });
  };
  var child$1 = function (scope, selector) {
    return $_5wrck919ljcgfodcn.child(scope, function (e) {
      return $_3uqbk019fjcgfod99.is(e, selector);
    });
  };
  var descendant = function (scope, selector) {
    return $_3uqbk019fjcgfod99.one(selector, scope);
  };
  var closest = function (scope, selector, isRoot) {
    return ClosestOrAncestor($_3uqbk019fjcgfod99.is, ancestor, scope, selector, isRoot);
  };
  var $_brpv7z19kjcgfodci = {
    first: first$1,
    ancestor: ancestor,
    sibling: sibling,
    child: child$1,
      ...
      menu: [
        {
          text: 'Left',
          icon: 'alignleft',
          onclick: $_giolxl19ojcgfoddu.toggleFormat(editor, 'alignleft')
        },
        {
          text: 'Center',
          icon: 'aligncenter',
          onclick: $_giolxl19ojcgfoddu.toggleFormat(editor, 'aligncenter')
        },
        {
          text: 'Right',
          icon: 'alignright',
          onclick: $_giolxl19ojcgfoddu.toggleFormat(editor, 'alignright')
        },
        {
          text: 'Justify',
          icon: 'alignjustify',
          onclick: $_giolxl19ojcgfoddu.toggleFormat(editor, 'alignjustify')
        }
      ]
    });
    Tools.each({
      ...
      editor.addButton(name, {
        ...
        tooltip: item[0],
        cmd: item[1],
        onPostRender: $_giolxl19ojcgfoddu.postRenderFormat(editor, name)
      });
    });
  };
  var $_8cd6g219njcgfodds = { register: register };

  var getSpecifiedFontProp = function (propName, rootElm, elm) {
    while (elm !== rootElm) {
      if (elm.style[propName]) {
        var foundStyle = elm.style[propName];
        return foundStyle !== '' ? $_b4b17x16mjcgfocip.some(foundStyle) : $_b4b17x16mjcgfocip.none();
      }
      elm = elm.parentNode;
    }
    return $_b4b17x16mjcgfocip.none();
  ...
  var getComputedFontProp = function (propName, elm) {
    return $_b4b17x16mjcgfocip.from(DOMUtils.DOM.getStyle(elm, propName, true));
  };
  var getFontProp = function (propName) {
    return function (rootElm, elm) {
      return $_b4b17x16mjcgfocip.from(elm).map($_ennn6d18njcgfocyy.fromDom).filter($_cspiqz18sjcgfod1i.isElement).bind(function (element) {
        return getSpecifiedFontProp(propName, rootElm, element.dom()).or(getComputedFontProp(propName, element.dom()));
      }).getOr('');
    };
  };
  var $_ggo6n619qjcgfoddz = {
    getFontSize: getFontProp('fontSize'),
    getFontFamily: $_23g2ob16njcgfocj8.compose(normalizeFontFamily, getFontProp('fontFamily')),
    toPt: toPt
  };
  ...
  var createFontNameListBoxChangeHandler = function (editor, items) {
    return function () {
      ...
      editor.on('init nodeChange', function (e) {
        var fontFamily = $_ggo6n619qjcgfoddz.getFontFamily(editor.getBody(), e.element);
  ...
  var $_88plsv19pjcgfoddw = { register: register$1 };
  ...
  var createFontSizeListBoxChangeHandler = function (editor, items) {
    return function () {
      ...
      editor.on('init nodeChange', function (e) {
        ...
        px = $_ggo6n619qjcgfoddz.getFontSize(editor.getBody(), e.element);
        if (px) {
          for (precision = 3; !match && precision >= 0; precision--) {
            pt = $_ggo6n619qjcgfoddz.toPt(px, precision);
  ...
  var $_2y91jw19rjcgfodec = { register: register$2 };
      ...
      return {
        ...
        onselect: function (e) {
          if (e.control) {
            ...
            $_giolxl19ojcgfoddu.toggleFormat(editor, fmt)();
          }
        },
  ...
  var buildMenuItems = function (editor, blocks) {
    return Tools.map(blocks, function (block) {
      return {
        text: block[0],
        onclick: $_giolxl19ojcgfoddu.toggleFormat(editor, block[1]),
        textStyle: function () {
          return editor.formatter.getCssText(block[1]);
        }
      };
  ...
  var $_6h1zlr19sjcgfodeg = { register: register$3 };
  ...
  var createFormatMenu = function (editor) {
    ...
    return {
      ...
      itemDefaults: {
        ...
        onclick: function () {
          if (this.settings.format) {
            $_giolxl19ojcgfoddu.toggleFormat(editor, this.settings.format)();
          }
  ...
  var $_dw9u5419tjcgfodek = { register: register$4 };
  ...
  var createCustomMenuItems = function (editor, names) {
    ...
    if (typeof names === 'string') {
      ...
      return $_f9szz16ljcgfocii.flatten(Tools.map(names, function (names) {
  ...
  var trimMenuItems = function (menuItems) {
    var menuItems2 = $_f9szz16ljcgfocii.filter(menuItems, function (menuItem, i, menuItems) {
      return !isSeparator(menuItem) || !isSeparator(menuItems[i - 1]);
    });
    return $_f9szz16ljcgfocii.filter(menuItems2, function (menuItem, i, menuItems) {
  ...
  var $_9gwmv019ujcgfodjs = { register: register$5 };
  ...
  var registerFormatButtons = function (editor) {
    Tools.each({
      ...
      editor.addButton(name, {
        ...
        tooltip: text,
        onPostRender: $_giolxl19ojcgfoddu.postRenderFormat(editor, name),
        onclick: $_giolxl19ojcgfoddu.toggleFormat(editor, name)
      });
    });
  };
  ...
  var registerMenuItems$1 = function (editor) {
    ...
    editor.addMenuItem('codeformat', {
      text: 'Code',
      icon: 'code',
      onclick: $_giolxl19ojcgfoddu.toggleFormat(editor, 'code')
    });
  };
  ...
  var $_eeo29a19vjcgfodjy = { register: register$6 };
  ...
  var $_g6hvui19wjcgfodk2 = { register: register$7 };
  ...
  var $_9t7n1l19xjcgfodk5 = { register: register$8 };
  ...
  var setupUiContainer = function (editor) {
    if (editor.settings.ui_container) {
      Env.container = $_brpv7z19kjcgfodci.descendant($_ennn6d18njcgfocyy.fromDom(document.body), editor.settings.ui_container).fold($_23g2ob16njcgfocj8.constant(null), function (elm) {
        return elm.dom();
      });
    }
  };
  ...
  var setup = function (editor) {
    ...
    setupEnvironment();
    $_6h1zlr19sjcgfodeg.register(editor);
    $_8cd6g219njcgfodds.register(editor);
    $_eeo29a19vjcgfodjy.register(editor);
    $_g6hvui19wjcgfodk2.register(editor);
    $_2y91jw19rjcgfodec.register(editor);
    $_88plsv19pjcgfoddw.register(editor);
    $_dw9u5419tjcgfodek.register(editor);
    $_9t7n1l19xjcgfodk5.register(editor);
    $_9gwmv019ujcgfodjs.register(editor);
  };
  var $_8pas7m19jjcgfodc6 = { setup: setup };
  ...
  var getApi = function () {
    return {
      ...
      ReflowQueue: $_60cq39171jcgfocl7,
      Control: Control$1,
      Factory: Factory,
      KeyboardNavigation: KeyboardNavigation,
      Container: Container,
      DragHelper: DragHelper,
      Scrollable: $_a5nsrg17ejcgfocnc,
      Panel: Panel,
      Movable: $_53brmf172jcgfoclb,
      Resizable: $_e8tepm17fjcgfocng,
      ...
      FormatControls: $_8pas7m19jjcgfodc6,
  ...
  ThemeManager.add('inlite', function (editor) {
    var panel = Panel$1();
    $_8pas7m19jjcgfodc6.setup(editor);
    $_fvtyc717hjcgfocnm.addToEditor(editor, panel);
    return $_e4y94h15zjcgfocgq.get(editor, panel);
  });
  var Theme = function () {
  };
